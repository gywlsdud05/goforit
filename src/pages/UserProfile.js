    ...
    return (
        <div className={styles.container}>
            <div className={styles.buttonGroup}>
                <button className={`${styles.button} ${styles.supporterButton}`}>서포터</button>
                <button className={`${styles.button} ${styles.makerButton}`}>메이커</button>
            </div>

            <div className={styles.profileSection}>
                <div className={styles.avatarContainer}>
                    <img src={profileData?.avatarUrl || "http://via.placeholder.com/100x100"}
                ...
                <div className={styles.profileInfo}>
                    <h2 className={styles.profileName}>{profileData?.nickname || '익명의 서포터'}</h2>
            ...
            <div className={styles.statsGrid}>
                <div className={styles.statItem}>
                    <div className={styles.statHeader}>
                        ...
                        <span className={styles.statValue}>{profileData?.point || 'not found'} P</span>
                    </div>
                </div>
                <div className={styles.statItem}>
                    <div className={styles.statHeader}>
                        <span className={styles.statTitle}>쿠폰</span>
                        <span className={styles.statValue}>{profileData?.coupon || 'not found'} 장</span>
                    </div>
                </div>
            </div>
